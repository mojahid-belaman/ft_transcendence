...
export function drawGame(context: object, data: Data) {
    ...
    drawBorder(0, 0, data.get_Width(), 0, '#FFF', data.get_borderHeight(), context);
    drawBorder(0, data.get_Height(), data.get_Width(), data.get_Height(), '#FFF', data.get_borderHeight(), context); 
    ...
    drawSeparator(data.get_Trace_X(), data.get_Trace_Y(), data.get_Trace_Width(), data.get_Trace_Height(), data.get_borderHeight(), '#FFF', context, data.get_Height());
...
function drawRect(x: number, y: number, w: number, h: number, color: string, context:any) {
  ...
  function drawSeparator(x: number, y: number, w: number, h: number, borderHeight: number, color: string, context: object, cHeight: number) {
    for (let index = borderHeight; index < cHeight - borderHeight; index+=borderHeight) {
